...
//equalsIgnoreCase 대소문자 구분 없이 하는것
            ...
            while (true) {
                ...
                System.out.print(">>");
                String register_agian = sc.nextLine();

                if (register_agian.equalsIgnoreCase("y")) {

                }else if (register_agian.equalsIgnoreCase("n")) {
                    System.exit(0);
                }
